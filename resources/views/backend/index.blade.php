						...
						<tbody>
						    @foreach($coches as $coche)
	    						<tr>
	    							...
	    							<td class="d-none d-md-table-cell">{{ $users->where('id', $coche->iduser)->first()->username }}</td>
	    							...
	    							@else
	    							    <td class="d-none d-md-table-cell"><span class="badge bg-danger">Retirado</span></td>
	    							@endif
	    							<td class="d-none d-md-table-cell"><a href="{{url('/backend/coche/' . $coche->id) }}" class="btn btn-info btn-sm">Ver</a></td>
	    							<td class="d-none d-md-table-cell"><a href="{{url('backend/coche/'. $coche->id . '/edit') }}" class="btn btn-info btn-sm">Editar</a></td>
	    						</tr>
	    					@endforeach
						</tbody>
					</table>
