...
class CocheEditRequest extends FormRequest
{
    ...
    public function messages() {
        ...
        $tinyInteger    = 'El campo \':attribute\' tiene que ser un numero entre 0 y 9.';
    ...
    public function rules()
    {
        return [
            ...
            'causa'            => 'nullable|in:null,vendido,retirado,otro',
        ];
    }
